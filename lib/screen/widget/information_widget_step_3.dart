import 'package:add_to_app_flutter_module/screen/widget/personalInfo.dart';
import 'package:flutter/material.dart';
import 'package:add_to_app_flutter_module/getController/information_controller.dart';
import 'package:add_to_app_flutter_module/widgets/pageLoading.dart';
...
class _InformationWidgetState extends State<InformationWidget> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return _infoController.isLoading.value
          ? pageLoading()
