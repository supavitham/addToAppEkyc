...
import 'package:add_to_app_flutter_module/screen/widget/information_widget_step_3.dart';
import 'package:add_to_app_flutter_module/screen/widget/kyc_widget_step_4.dart';
import 'package:add_to_app_flutter_module/screen/widget/otp_widget_step_2.dart';
import 'package:add_to_app_flutter_module/screen/widget/phone_number_step_1.dart';
import 'package:flutter/material.dart';
import 'package:add_to_app_flutter_module/api/httpClient/pathUrl.dart';
import 'package:add_to_app_flutter_module/api/post.dart';
import 'package:add_to_app_flutter_module/getController/e_kyc_controller.dart';
import 'package:add_to_app_flutter_module/getController/information_controller.dart';
import 'package:add_to_app_flutter_module/getController/kyc_controller.dart';
import 'package:add_to_app_flutter_module/utility/deviceSerial.dart';
import 'package:add_to_app_flutter_module/utility/fileUitility.dart';
import 'package:add_to_app_flutter_module/utility/format.dart';
import 'package:add_to_app_flutter_module/widgets/buttonCancel.dart';
import 'package:add_to_app_flutter_module/widgets/buttonConfirm.dart';
import 'package:add_to_app_flutter_module/widgets/cameraScanIDCard.dart';
import 'package:add_to_app_flutter_module/widgets/dialog/customDialog.dart';
import 'package:add_to_app_flutter_module/widgets/dialog/deleteDialog.dart';
import 'package:add_to_app_flutter_module/widgets/errorMessages.dart';
              ...
              child: Obx(() => Row(
                    ...
                    children: [
                      ...MultiLanguage.values.map((e) {
                        bool selected =
                            e == _eKYCController.currentLanguage.value;
                          ...
                          children: [
                            GestureDetector(
                              onTap: () {
                                ...
                                _eKYCController.currentLanguage.value ==
                                        MultiLanguage.th
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                    image: AssetImage(
                                        'packages/add_to_app_flutter_module/assets/images/${index == 0 ? selected ? "Thailand-flag" : "Thailand-flag-bw" : selected ? "United_Kingdom" : "United_Kingdom_bw"}.png'),
                                    fit: BoxFit.fill,
                                  ),
      ...
      case StepKYC.two:
        {
          ...
          // remove step 2
          _eKYCController.processStepKYC
              .removeWhere((element) => element.select == nowStep);
          // update status step 1
          _eKYCController.processStepKYC
              .firstWhere((p0) => p0.select == StepKYC.one)
              .statusDone = false;
      ...
      case StepKYC.three:
        {
          ...
          _eKYCController.processStepKYC
              .firstWhere((p0) => p0.select == StepKYC.two)
              .statusDone = false;
      ...
      case StepKYC.four:
        {
          ...
          _eKYCController.processStepKYC
              .firstWhere((p0) => p0.select == StepKYC.three)
              .statusDone = false;
              ...
              child: ButtonConfirm(
                ...
                onPressed: () async {
                  if (_formKeyPhoneNumber.currentState!.validate() &&
                      _eKYCController.cPhoneNumber.text.length == 12) {
              ...
              Expanded(
                child: ButtonCancel(
                  ...
                  onPressed: () {
                    ...
                    _eKYCController.hasErrorOTP.value = false;
                    // back step 1
                    _eKYCController.processStepKYC.removeWhere(
                        (element) => element.select == StepKYC.two);
                    _eKYCController.selectStepKYC.value = StepKYC.one;
                    _eKYCController.processStepKYC
                        .firstWhere((p0) => p0.select == StepKYC.one)
                        .statusDone = false;
                          ...
                          try {
                            if (data != null && !data['ocrFailedAll']) {
                              ...
                              _infoController.personalInfo.value.lastName =
                                  data['ocrFrontSurname'];
                              _infoController.personalInfo.value.address =
                                  data['ocrFrontAddress'];
                              _infoController.personalInfo.value.filterAddress =
                                  data['ocrFilterAddress'];
                              _infoController.personalInfo.value.birthday =
                                  data['ocrBirthDay'];
                              _infoController.personalInfo.value.ocrBackLaser =
                                  data['ocrBackLaser'];

                              _infoController.idCardController.text =
                                  data['ocrFrontID'];
                              _infoController.firstNameController.text =
                                  data['ocrFrontName'];
                              _infoController.lastNameController.text =
                                  data['ocrFrontSurname'];
                              _infoController.addressController.text =
                                  data['ocrFrontAddress'];
                              _infoController.birthdayController.text =
                                  data['ocrBirthDay'];
                              _infoController.ocrBackLaser.value =
                                  data['ocrBackLaser'];
                              _infoController.ocrFailedAll.value =
                                  data['ocrFailedAll'];
                              _infoController.imgFrontIDCard =
                                  File(data['frontIDPath']);
                              _infoController.imgBackIDCard =
                                  File(data['backIDPath']);
                              _infoController.acceptScanCardIDWidget.value =
                                  false;
                              _infoController.imgFrontIDCardBytes =
                                  data['frontIDPathFile'];
                              ...
                              (v) async {
                                if (v != null) {
                                  ...
                                  if (_infoController.pathSelfie.isNotEmpty) {
                                    await File(_infoController.pathSelfie.value)
                                        .delete();
                                  }
                                  if (!isImage(v)) {
                                    showDialog(
                        ...
                        child: Container(
                          ...
                          child: MaterialButton(
                            ...
                            onPressed: () async {
                              ...
                              _infoController.fileNameFrontID.value =
                                  resFrontID['response']['data']['file_name'];
                              ...
                              _infoController.fileNameBackID.value =
                                  resBackID['response']['data']['file_name'];
                              ...
                              _infoController.fileNameSelfieID.value =
                                  resSelfieID['response']['data']['file_name'];
                              ...
                              var resCreateUser =
                                  await _infoController.createUser();
                                ...
                                showDialog(
                                  ...
                                  builder: (context) => CustomDialog(
                                    ...
                                    onPressedConfirm: () {
                                      ...
                                      _eKYCController.processStepKYC
                                          .removeWhere((element) =>
                                              element.select == StepKYC.four);
                                      // update status step 3
                                      _eKYCController.processStepKYC
                                          .firstWhere((p0) =>
                                              p0.select == StepKYC.three)
                                          .statusDone = false;
                                      _eKYCController.selectStepKYC.value =
                                          StepKYC.three;
